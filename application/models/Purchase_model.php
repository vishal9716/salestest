...
$sql = "select distinct d.department_name,pr.department_id,pr_issue_date,supplier_name,expense,pr_recd_on,order_placed_by,employee_types,phone_person from purchase_request pr join department d on(pr.department_id=d.department_id) where sr_no= '".$pr_srno."'";
	//echo $sql; die;
	$result = $this->db->query($sql)->result_array();
	//echo "<pre/>"; print_r($result); die;
	 return $result;
