...
$query="update purchase_request set department_id='".$department_id."',unit_region_id='".$unit_region_id."',supplier_name='".$supplier_name."', expense='".$expense."', pr_issue_date='".$issuing_date."',phone_person='".$phone_person."',action_taken_by='".$action_taken_by."', pr_recd_on='".$pr_reacd_on."',order_placed_by='".$order_placed_by."',status='Pending' where sr_no='".$pr_srno."'";
