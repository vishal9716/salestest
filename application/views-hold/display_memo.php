<?php echo $this->load->view("common/top"); ?>
       ...
       <div ng-app="gaigDemo" id="page-wrapper" class="" ng-controller="DemoCtrl as demo">
            <div class="row">
                <div class="col-lg-12">
		<h1 class="page-header" style="font-size: 26px; margin: 10px 0 20px;">INTERNAL MEMO For PR - <?php echo $_GET['pr_no'];?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
		 <?php
        ...
        <div class="gaig-sidebar-inner">
          <!-- set height for demo only -->
		   ...
		   <?php } ?>   
		    <div class="row">
	 <div class="col-md-2">
   <button type="submit" class="btn btn-primary btn-flat pull-left" onclick="internal_memo();" id="">Update  Memo</button>
				</div>
				</div>
            <!-- /.row -->
