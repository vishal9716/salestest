                                ...
                                <div class="col-lg-6">
									...
									?>
										<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter customer name" type="text" name="customer_name" id="customername" value="<?php echo $recordslist['customer_name'];?>" required>                                            
                                        </div> 																				
									...
									<?php } ?>									
                                        ...
                                        <button type="reset" name="cancel" class="btn btn-default" onclick="location='<?php echo base_url(); ?>index.php/'">Cancel</button>
                                    </form>
                                </div>
