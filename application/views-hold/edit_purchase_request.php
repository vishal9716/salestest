<?php echo $this->load->view("common/top"); ?>
	...
	<?php } ?>				
										...
										<input type="button" value="Add Row" onclick="insRow('myTable')" />				
											...
											<tr>
	<td>
   <textarea class="form-control" cols="7" rows="1" name="pr_desp[]" id="pr_desp"><?php echo $purchase_request_list[$i]['pr_description'];?></textarea>
   </td>
 <td>
...
//alert(selectedOption);
	...
	//alert("<?php echo base_url(); ?>index.php/purchase_request/update_pr/"+sr_no);
         $.ajax({
            method: "POST",
            url: "<?php echo base_url(); ?>index.php/purchase_request/update_purchase_request/"+sr_no,
