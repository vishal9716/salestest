        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                   ...
                   <label for="">Supplier/Make Referred<a href="#" data-toggle="modal" data-target="#supplierModal" style="margin-left: 39px;" class="btn-border-orange"><span class="fa fa-plus"> &nbsp;</span>New Supplier</a></label>
    ...
    <div class="modal fade" id="supplierModal" role="dialog" style="overflow:hidden;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-info">Supplier Information</h4>
                </div>
                <div class="modal-body">
                    <form action="" method="post" id="SupplierAdd" class="form-horizontal">
                        ...
                        <div class="box-footer">
                            <a href="" class="btn btn-info btn-flat">Cancel</a>
                            <input type="button" class="btn btn-info" name="button" value="Submit" onclick="add_supplier();"/>
