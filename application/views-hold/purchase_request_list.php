...
<div id="page-wrapper" style="width:100%;">
    ...
    <div class="row">
        ...
        <!-- <td><?php echo $list['phone_person']; ?></td>-->
                                        ...
                                        <?php if ($username == 'konain' && ($list['status'] == 'Pending' || $list['status'] == 'Rejected')) { ?> <td><a href="<?php echo base_url(); ?>index.php/purchase_request/edit_purchase_request?sr_no=<?php echo $list['sr_no']; ?>">Edit</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/internal_memo?sr_no=<?php echo $list['sr_no']; ?>">Memo</a> </td> 

                                        <?php } else if ($username == 'pooja' && $list['status'] == 'Approved') {
                                            ?>  <td><a href="" class="disabled">Edit</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/internal_memo?sr_no=<?php echo $list['sr_no']; ?>" class="disabled">Memo</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/pr_quotation">Quotation</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/checklist?sr_no=<?php echo $list['sr_no']; ?>">Checklist</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/negotiation?sr_no=<?php echo $list['sr_no']; ?>">Negotiation</a> | <a href="<?php echo base_url(); ?>index.php/purchase_request/comparision?sr_no=<?php echo $list['sr_no']; ?>">Comparision </a>| <a href="<?php echo base_url(); ?>index.php/purchase_request/audit_checklist?sr_no=<?php echo $list['sr_no']; ?>">Audit</a></td>





                                        <?php } else if (($username == 'parul') || ($username == 'vikas') && ($list['status'] == 'Pending' || $list['status'] == 'Approved' || $list['status'] == 'Rejected')) { ?>  <td><a href="<?php echo base_url(); ?>index.php/purchase_request/display_memo?pr_no=<?php echo $list['sr_no']; ?>">Edit Memo</a>  </td> 
