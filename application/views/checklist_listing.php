<?php echo $this->load->view("common/top"); ?>
	...
	<span class="activity pull-right btn btn-default btn-sm"><a href="<?php echo base_url();?>index.php/purchase_request/purchase_request_list">Back to PR List</a></span>
                        </div>
                        <!-- /.panel-heading -->
