...
?>
	  ...
	  <input type="radio" name="optradio" checked>   Journal</label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control auto ui-autocomplete-input" placeholder="" name="total_pages">
                <span id="errMsg" class="text-danger"></span>
            </div>
          </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input class="form-control auto ui-autocomplete-input" placeholder="Search Item" name="volume" id="search" autocomplete="off">
			 ...
			 <div class="col-md-6">
              <div class="form-group">
                  <label for="exampleInputEmail1">Complexity Level</label>
                  <input class="form-control" placeholder="Search Item" name="level">
	...
	<div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  <label for="exampleInputEmail1">No. Of illustrations/Arts</label>
                  <input class="form-control auto ui-autocomplete-input" placeholder="Search Item" name="illustrations">
	...
	<div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Search Item">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-info">Customers Information</h4>
        </div>
        <div class="modal-body">
         <form action="<?php echo base_url(); ?>index.php/operations/add_customer" method="post" id="customerAdd" class="form-horizontal">
                ...
                <div class="box-body">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="col-md-6">
                              <h4 class="text-info text-center" style="margin-left: 90px;">Shipping Address <button id="copy" class="btn btn-default btn-xs" type="button">Copy Address</button></h4>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <!--  <h4 class="text-info text-center" style="margin-left: 40px;">Project Information</h4>-->
                            ...
                            <div class="form-group">
                              <label class="col-sm-4 control-label" for="volume">Volume</label>
