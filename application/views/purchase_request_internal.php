            ...
            <form action="" method="post" name="Formulaire">  
              ...
              <!--<textarea class="example-default-value" id="example-textarea" style="width: 400px; height: 50px;">Test</textarea>-->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""><a href="#" onclick="createPurchaseRequest()" data-target="#prModal"><span class="fa fa-plus"> &nbsp;</span>PURCHASE REQUISITION</a></label>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="card">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-md-2"><input class="form-control" placeholder="Enter PR S. No." id="sr_no" name="sr_no" readonly="readonly" ></div>
                            </div>
                            <div class="card-body">
                                <div id="table" class="table-editable ">
                                    ...
                                    <table class="table table-bordered table-responsive-md table-striped text-center mb-0" id="crud_table">
                                        ...
                                        <tbody>
                                            <tr id="row1">
                                                <td class="pr_srno" id="pr_srno_1" contenteditable="true"></td>
...
// For adding Supplier
                            ...
                            $(document).ready(function () {
                                ...
                                $('#add').click(function () {
                                    ...
                                    html_code += "<td class='pr_srno' id='pr_srno_1" + count + "' contenteditable='true'></td>";
                                ...
                                $('#save').click(function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            // alert(data);
                                            $('#departmentsDropdownSelect').attr("disabled", true); 
                                            $('#prModal').modal('hide');
