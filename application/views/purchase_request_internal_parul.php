...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Purchase Request Creation</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="card">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col-md-1">PR SNo -	</div>
                                <div class="col-md-2"><input class="form-control" placeholder="" id="sr_no" name="sr_no" ></div>
                            </div>
                            <div class="card-body">
