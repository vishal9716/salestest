...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Outstanding Payment</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Outstanding Payment add Form
							</div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="frm-outstanging" method="post" action="add_outstanding_payment" enctype="multipart/form-data">
