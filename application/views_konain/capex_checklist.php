                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="even gradeC">
                                        <td>1.</td>
                                        <td>Purchase SOP Audit Checklist</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									 <tr class="even gradeC">
									...
									<tr class="even gradeC">
                                        <td>6.</td>
                                        <td>Negotiation Matrix</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>7.</td>
                                        <td>Delivery date and schedule	</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>8.</td>
                                        <td>Shortlisted Vendor recommendation</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>9.</td>
                                        <td>Final Negotiated rate with payment term</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>10.</td>
                                        <td>CAPEX Statement</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>11.</td>
                                        <td>OPEX (Included within Budgeted Amount)</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
									<tr class="even gradeC">
                                        <td>12.</td>
										<td>Approval<ul style="list-style: none;">
											<li>1. Upto30,000 – Unit Head</li><br/>
											<li>2. 30,001 to 20,00,000 – ED</li><br/>
											<li>3. 20,00,001 & Above - MD</li><br/>
											</ul></td>
                                        <td></td>
                                        <td></td>
                                    </tr>								
