...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit JTN Issue</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-6">
									...
									?>
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="jtn_issue_date" value="<?php echo $recordslist->jtn_issue_date;?>" id="jtn_issue_date">
											&nbsp;<?php echo date("d/m/Y",strtotime($recordslist->jtn_issue_date));?>
											<input type="hidden" name="jtn_issue_date_hid" value="<?php echo $recordslist->jtn_issue_date;?>">
                                        </div>
										 <div class="form-group">
										 ...
										 <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="job_rec_date" id="job_rec_date" value="<?php echo $recordslist->job_receive_date;?>">
											&nbsp;<?php echo date("d/m/Y",strtotime($recordslist->job_receive_date));?>
											<input type="hidden" name="job_rec_date_hid" value="<?php echo $recordslist->job_receive_date;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Job due Date</label>
                                            <input class="form-control" type="date" name="job_due_date" id="job_due_date" value="<?php echo $recordslist->job_due_date;?>">
											&nbsp;<?php echo date("d/m/Y",strtotime($recordslist->job_due_date));?>
											<input type="hidden" name="job_due_date_hid" value="<?php echo $recordslist->job_due_date;?>">
                                        </div>
										<div class="form-group">
										...
										<input type="hidden" name="jtn_id_hid" value="<?php echo $_GET['jtnid'];?> ">
                                        </div>								
																			
											
                                        <button type="submit" name="submit" class="btn btn-default">Request JTN</button>
										<button type="button" name="notify" class="btn btn-default" onclick="location='<?php echo base_url(); ?>jtn/notify'">Notify Project Manager</button>
                                        <button type="reset" name="cancel" class="btn btn-default" onclick="location='<?php echo base_url(); ?>jtn/index'">Back</button>
                                    </form>
