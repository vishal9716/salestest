...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Outstanding Payment</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Outstanding Payment Edit Form
							</div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="frm-outstanding" method="post" action="edit_outstanding_payment" enctype="multipart/form-data">
									...
									?>
										...
										<div class="form-group">
										 ...
										 <div class="form-group">                                            
											...
											<input type="hidden" name="hid_receiveable_id" id="hid_receiveable_id" value="<?php echo $receivable_id; ?>">
                                        </div>
														
																	
											
                                        <button type="submit" name="submit" class="btn btn-default">Edit Report</button>
										<button type="reset" name="cancel" class="btn btn-default" onclick="location='<?php echo base_url(); ?>outstanding_payment/index'">Cancel</button>
                                    </form>
                                </div>
			...
			<script>		 		
				document.getElementById("customer_name").value='<?php echo $customer_name;?>';
				document.getElementById("overdue_for").value='<?php echo $overdue_for;?>';
