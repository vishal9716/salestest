        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <option id="departmentsDropdown" value="<?php echo $customer['customer_id'];?>"><?php echo $customer['customer_name'];?></option>     
    <?php } ?>  
	 </select> 		  
		       </div>
...
?>
			...
			<label for="">Unit-Measurement</label>
              ...
              <div class="form-group">
				...
				<span><button type="button" class="btn btn-success btn-flat pull-left" id="btnSubmit" onclick="location='http://localhost/Sales/index.php/mhr'">Calculate</button></span>
              </div>
