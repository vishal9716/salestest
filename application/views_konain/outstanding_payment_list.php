 <?php $this->load->view('common/top');?>
	...
	function deletereceivable(reid)
	{
		...
		if (r == true) {
		  window.location.href = "<?php echo base_url(); ?>outstanding_payment/delete_outstanding?rid="+reid;
		} else {
		  window.location.href = "<?php echo base_url(); ?>outstanding_payment/";
		} 
	}
	</script>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Outstanding payment List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span>Outstanding payment list form</span> <span class="activity"><a href="<?php echo base_url(); ?>outstanding_payment/add_outstanding_payment">Create </a></span>
                        </div>
                        <!-- /.panel-heading -->
								...
								?>
                                    ...
                                    <tr class="<?php echo $classname; ?>">
										...
										<td><?php echo $recordslist->total_overdue;?> </td>
                                       	<td><a href="<?php echo base_url(); ?>outstanding_payment/edit_outstanding_payment?revid=<?php echo $recordslist->receivable_id;?>">Edit</a> / <a href="javascript:deletereceivable('<?php echo $recordslist->receivable_id;?>');">Delete</a></td>
                                    </tr>
								<?php } 
								} else {
								?>
