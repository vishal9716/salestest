            ...
            <div class="panel panel-default">
                ...
                <!--<span class="label label-danger">Reject</span>-->
                                   ...
                                   <!-- <td><?php echo $list['phone_person']; ?></td>-->
										...
										<?php } else if ($username == 'konain' && $list['status']=='Approved') {
										...
										<?php } else if ($username == 'parul' && ($list['status']=='Pending' || $list['status']=='Approved' || $list['status']=='Rejected')) { ?> <!-- <td><a href="<?php echo base_url(); ?>index.php/purchase_request/edit_purchase_request?sr_no=<?php echo $list['sr_no']; ?>">Edit</a>  </td> -->
