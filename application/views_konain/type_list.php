...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Type List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								//print_r($userdata);
								$i=0;
								foreach($typedata as $recordslist) {
									$i++;
									if($i%2==0)
									{
								...
								?>
                                    ...
                                    <tr class="<?php echo $classname; ?>">
                                        <td><?php echo $i; ?></td>
                                        <!-- <td><?php echo $recordslist->type_id;?></td> -->
                                        <td><?php echo $recordslist->type_name;?> </td>
                                       	<td><a href="/commercial/type/edit_type?tid=<?php echo $recordslist->type_id;?>">Edit</a> </td>
                                    </tr>
								<?php } ?>
